...
public final class ResourceUtils {
    ...
    public static int getKeyboardHeight(
        ...
        final int defaultKeyboardHeight =
                getDefaultKeyboardHeight(res);

        float scale =
                settingsValues.mKeyboardHeightScale;

        /*
         * Slightly reduce the physical keyboard height
         * so that the keyboard does not cover the app's
         * bottom controls (for example WhatsApp's send button).
         *
         * 0.90f = 10% smaller
         */
        final float uiScale = 0.78f;
