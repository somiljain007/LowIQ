...
public final class KeyboardSwitcher
    ...
    private static final String TAG =
            KeyboardSwitcher.class.getSimpleName();
    ...
    public void updateKeyboardTheme() {
        final boolean themeUpdated =
                updateKeyboardThemeAndContextThemeWrapper(
                        mLatinIME,
                        KeyboardTheme.getKeyboardTheme(mLatinIME));
    ...
    public void loadKeyboard(
        ...
        final int keyboardHeight =
                ResourceUtils.getKeyboardHeight(
                        res,
                        settingsValues);

        final int keyboardBottomOffset =
                ResourceUtils.getKeyboardBottomOffset(
                        res,
                        settingsValues);

        builder.setKeyboardTheme(
                mKeyboardTheme.mThemeId);
        ...
        builder.setShowSpecialChars(
                settingsValues.mShowSpecialChars);

        builder.setShowNumberRow(
    ...
    private void setKeyboard(
        ...
        final Keyboard newKeyboard =
                mKeyboardLayoutSet.getKeyboard(
                        keyboardId);
        ...
        final boolean subtypeChanged =
                oldKeyboard == null
                        || !newKeyboard.mId.mSubtype.equals(
                        oldKeyboard.mId.mSubtype);

        final int languageOnSpacebarFormatType =
                LanguageOnSpacebarUtils
                        .getLanguageOnSpacebarFormatType(
        ...
        if (DEBUG_ACTION) {
            Log.d(
                    ...
                    "requestUpdatingShiftState: "
                            + "autoCapsFlags="
                            + CapsModeUtils.flagsToString(
                            autoCapsFlags)
                            + " recapitalizeMode="
                            + RecapitalizeStatus.modeToString(
                            recapitalizeMode));
        }
    ...
    public boolean isInDoubleTapShiftKeyTimeout() {
        ...
        return keyboardView != null
                && keyboardView.isInDoubleTapShiftKeyTimeout();
    }
    ...
    public boolean isShowingKeyboardId(
            int... keyboardIds) {
    ...
    public boolean isShowingMoreKeysPanel() {
        return mKeyboardView != null
                && mKeyboardView.isShowingMoreKeysPanel();
    }
    ...
    /**
     * Creates the keyboard input view.
     *
     * The SmartBar is handled entirely by input_view.xml.
     * Do NOT create, position, or add the SmartBar here.
     */
    public View onCreateInputView() {
        ...
        final InputView currentInputView =
                (InputView) LayoutInflater
                        .from(mThemeContext)
                        .inflate(
                                R.layout.input_view,
                                null);
